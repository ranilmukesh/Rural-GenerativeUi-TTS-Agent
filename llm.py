...
def start_chat_session(
    ...
    agent = Agent(
        ...
        tools=[award_paati_points, check_government_schemes, get_tenali_puzzle, generate_mini_game, DuckDuckGoTools()],
        description=(
        ...
        instructions=[
            ...
            "GOAL 3: Use 'check_government_schemes' to find real jobs/training for them when they reach 500 points. USE DuckDuckGoTools to search the live web for recent application deadlines or links regarding that scheme.",
